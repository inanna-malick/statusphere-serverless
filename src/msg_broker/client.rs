...
use worker::{request_to_wasm, HttpResponse, ObjectNamespace, Stub};
...
impl MessageBroker {
    ...
    pub async fn connect(&self) -> Result<HttpResponse, AppError> {
        let mut request = worker::Request::new("https://stub.com/websocket", worker::Method::Get)
